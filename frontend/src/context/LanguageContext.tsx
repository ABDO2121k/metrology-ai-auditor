...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    findingsBlocking: "Anomalies bloquantes",
    findingsWarnings: "Avertissements",
    findingsSuggestions: "Suggestions",
    certColConformity: "Conformité",
    kpiJudgedSub: "points jugés",
    kpiNoneJudged: "aucun point jugé à ce jour",
    kpiUndecided: "Conformité indéterminée",
    kpiUndecidedSub: "Revue humaine requise",
  ...
  en: {
    ...
    findingsBlocking: "Blocking anomalies",
    findingsWarnings: "Warnings",
    findingsSuggestions: "Suggestions",
    certColConformity: "Conformity",
    kpiJudgedSub: "judged points",
    kpiNoneJudged: "no point judged yet",
    kpiUndecided: "Conformity undecided",
    kpiUndecidedSub: "Human review required",
  ...
  ar: {
    ...
    findingsBlocking: "حالات شاذة حاجبة",
    findingsWarnings: "تحذيرات",
    findingsSuggestions: "اقتراحات",
    certColConformity: "المطابقة",
    kpiJudgedSub: "نقاط تم الحكم عليها",
    kpiNoneJudged: "لم يتم الحكم على أي نقطة بعد",
    kpiUndecided: "المطابقة غير محسومة",
    kpiUndecidedSub: "تتطلب مراجعة بشرية",
